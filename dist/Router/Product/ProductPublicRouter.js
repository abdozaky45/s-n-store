...
const ProductPublicRouter = (0, express_1.Router)();
...
ProductPublicRouter.get("/get-all-products", (0, ValidationMiddleware_1.Validation)(ProductValidation.getUserAllProductsValidation), ProductController.findUserAllProductsByFilters);
ProductPublicRouter.post("/products-stock", ProductController.findProductsStock);
exports.default = ProductPublicRouter;
